...
class ArxivAbstractDB:
    ...
    generated by the Ollama model. It provides methods to add new abstracts and query existing ones.

    Attributes:
        db_path (str): Path to the ChromaDB database directory
        chroma_client: ChromaDB client instance
        embedding_function: Ollama embedding function instance
    ...
    def __init__(self, db_path: str = "./chroma_abstract_db"):
        ...
        self.embedding_function = ollama_ef
    ...
    def check_query_relevance(self, query: str, threshold: float = 0.75) -> tuple[float, bool]: 
        ...
        try:
            ...
            # Ollama returns L2 distances, convert to similarity score (0 to 1)
...
class ArxivFullTextDB:
    ...
    generated by the Ollama model. It provides methods to add new papers and query existing ones.
...
def main():
    ...
    arxiv_full_text_fetcher = ArxivFullTextFetcher()

    prompt = "BERT"
    
    # Fetch and add abstracts
    # result = arxiv_abstract_db.check_query_relevance(prompt)
    result_from_query = arxiv_full_text_fetcher.fetch_arxiv_full_text_from_query(prompt, max_results=20)

    print(result_from_query)

    arxiv_full_text_db.add_papers(result_from_query)
